...
class IpyleafletWFS:
    ...
    def build_layer(self, layer_typename: str, source_map, layer_style=None, feature_property=None):
        """
        ...
        layer_style : dict
            A layer style dictionary in ipyleaflet GeoJSON style format, for example:
    ...
    def create_wfsgeojson_layer(self, layer_typename: str, source_map, layer_style: dict | None = None):
        """
    ...
    def _refresh_layer(self, placeholder: str | None = None):  # noqa: F841
        """
    ...
    def feature_properties_by_id(self, feature_id: int) -> Any | None:
        """
    ...
    def _set_widget(self, widget_name, feature_property, src_map, textbox, widget_position):
        ...
        self._property_widgets[widget_name]["widget"] = ipyl.WidgetControl(widget=textbox, position=widget_position, min_width=120, max_width=120)
    ...
    def create_feature_property_widget(
        ...
        feature_property : str, optional
            The property key to be used by the widget. Use the property_list() function
            to get a list of the available properties.
            If left empty, it will default to the first property attribute in the list.
        ...
        def _update_textbox(properties=None, **kwargs):
            ...
            textbox.value = f"""
                <h4>{key}<h4>
                <b style="font-size:10px">{properties[key]}<b>
            """
