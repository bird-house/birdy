...
class BaseConverter:  # noqa: D101
    ...
    def __init__(
        ...
        verify : bool
            Whether to verify that disk access is permitted.
            Default: True.
        """
    ...
    def _check_import(self, name: str, package: str | None = None):
        """
...
def find_converter(obj: Output | str | Path, converters: Sequence[BaseConverter]) -> list:
    """
