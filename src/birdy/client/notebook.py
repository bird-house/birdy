...
class Form:
    ...
    def get(self, asobj: bool = False):
        ...
        """
        # Mimics the `WPSResult.get` method, to provide a consistent look and feel to all user interfaces.
    ...
    def build_ui(self, input_widgets, of_widgets, go):
        ...
        ui = widgets.AppLayout(header=header, left_sidebar=inputs, right_sidebar=outputs, footer=go)
