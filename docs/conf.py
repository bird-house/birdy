#!/usr/bin/env python
#
# birdy documentation build configuration file, created by
...
extlinks = {
    "issue": ("https://github.com/bird-house/birdy/issues/%s", "GH/%s"),
    "pull": ("https://github.com/bird-house/birdy/pull/%s", "PR/%s"),
...
version = birdy.__version__
# The full version, including alpha/beta/rc tags.
release = birdy.__version__
